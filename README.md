  .app-2rEoOp {
  background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.694) 33%, rgba(0, 0, 0, 0.598) 65%), url(https://i.imgur.com/4HkRXAt.jpg);
  background-size: cover;
  border: 1px;
}

.standardSidebarView-3F1I7i {
  background-image: url(https://i.imgur.com/4HkRXAt.jpg);
  background-size: cover;
}
...
.grabber-3mFHz2 {
  background-image: url("https://i.imgur.com/nj2i1zD.jpg?1");
  border: none;
  box-shadow: none;
  background-size: cover;
...
.theme-dark .ctaBar-2UsjF2{
    background-image: url(https://imgur.com/cnPzHXL);
}
